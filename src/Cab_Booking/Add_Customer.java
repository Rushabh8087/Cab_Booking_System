...
{
    JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id13; //variable
    JFrame f;    //here we use one frame
    JTextField t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13;
    JButton b,b1;    //here we use two button in frame
    
    Add_Customer()   //deafault constructor
    {
        f=new JFrame("Add Employee Details");    //heading
        f.setBackground (Color.WHITE);
        f.setLayout (null);
        
        id=new JLabel();//object is create
        id.setBounds (0,0,900,600);  //label size from x,y axis
        id.setLayout (null);
        
       ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("Cab_Booking/Icons/T.jpg"));
       ...
       id.add(id1);  //label(id1) added into image(id)
       f.add(id);//image(id) added in frame
       
       id2=new JLabel("Username"); 
       id2.setBounds (50,150,150,50); 
       ...
       f.setVisible(true);   //to show frame
       f.setSize(900,600);   //size of frame
       f.setLocation (300, 100);   //open from x and y axis at dist. of 300,100.
       
       
    }
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==b)     //if we click on button 1
        {
            String username=t1.getText();  //here value of textfield1 is store in variable1 
