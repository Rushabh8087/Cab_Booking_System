...
public class Update_Customer extends JFrame implements ActionListener     
{
    ...
    Update_Customer()
    {
       ...
       l12=new JLabel(ic1);
        ...
        p1=new JPanel();      //here we divide frame in three panel
        ...
        p3=new JPanel();
        p3.setLayout(new GridLayout(11,2,10,10));     //panel is divide into 11 rows and 2 coloums by GridLayout
        p3.add(l2);
        p3.add(ch);
        p3.add(l3);
        p3.add(tf1);
        ...
        public void mouseClicked(MouseEvent arg0)
        {
            try
            {
                ...
                String username=ch.getSelectedItem();   //CHOICE THE USERNAME WHOSE DETAILS WE HAVE TO UPADATE
    ...
    public void actionPerformed(ActionEvent e)  //BUTTON CODING HERE //WE HAVE TO OVERRIDE INTERFACE METHODS
    {           
       if(e.getSource()==bt1)
       {
            String username=ch.getSelectedItem();  //here value of textfield1 is store in variable1 
